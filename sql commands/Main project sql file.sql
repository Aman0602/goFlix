...
create table Users(UserNo int primary key identity, Name varchar(50), UserId varchar(50), Upassword varchar(50),SecurityQ varchar(100), Answer varchar(50))
...
create table WatchedMovies(SerialNo int primary key identity,UserNo int references Users(UserNo),MovieId int references Movies(MovieId))

insert into WatchedMovies values(1,2)
insert into WatchedMovies values(1,4)
insert into WatchedMovies values(1,8)
insert into WatchedMovies values(1,20)
insert into WatchedMovies values(1,13)
insert into WatchedMovies values(1,34)

insert into WatchedMovies values(2,29)
insert into WatchedMovies values(2,27)
insert into WatchedMovies values(2,52)
insert into WatchedMovies values(2,62)

select * from WatchedMovies



create table Rating(RatingId int primary key identity ,rating int,MovieId int references Movies(MovieId),UserNo int references Users(UserNo))
